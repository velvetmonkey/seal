...
2. [RELEASE-NOTES-v0.2.0-rc.1.md](RELEASE-NOTES-v0.2.0-rc.1.md) — what v0.2.0-rc.1 contains and
...
1. [“What Seal covers, and what it does not”](../README.md) — the boundary
   ...
   x86-64 only.
2. [“What Seal does not cover” in the release notes](RELEASE-NOTES-v0.2.0-rc.1.md) —
...
Dated records of how v0.2.0-rc.1 got its shape. Several describe designs that were
