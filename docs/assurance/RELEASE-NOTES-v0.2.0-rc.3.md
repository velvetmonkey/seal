...
- The receipt checker can now be invoked directly from a path that needs URL encoding. See the [executable-main check at the release commit](https://github.com/velvetmonkey/seal/blob/8dc16042cc1e865651185778df38dd114ff9ba3d/checker/seal-receipt-check.mjs).
