...
- Evidence-checking tooling accepts committed log tails from open child sessions, test temporary roots are cleaned on termination signals, and candidate metadata identifies v0.5.0 in the inherited source; v0.5.1 changes the candidate version (`e7a4d93`, `862bc6a`, `70985bb`).
