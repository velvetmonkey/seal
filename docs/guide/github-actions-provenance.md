...
$ if command -v shasum >/dev/null 2>&1; then shasum -a 256 demo-receipt-provenance/demo-receipt-evidence.tgz; else sha256sum demo-receipt-provenance/demo-receipt-evidence.tgz; fi
