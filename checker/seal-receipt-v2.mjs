...
if (process.argv[1] && import.meta.url === pathToFileURL(process.argv[1]).href) {
  ...
  try { const out = await verify(readFileSync(file, "utf8"), { publicKeyHex: keyAt > 0 ? process.argv[keyAt + 1] : undefined }); console.log(format(out)); if (!out.signature) process.exitCode = 1; }
