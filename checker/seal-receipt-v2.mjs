...
export function canonical(value) {
  ...
  if (typeof value === "number") {
    if (!Number.isFinite(value) || value < -9007199254740991 || value > 9007199254740991) fail("number is not finite or is outside the safe canonical range", "number_not_canonical");
