...
const SOURCED_BLOCKS = [
  ...
  `Seal v${VERSION} supports Linux x86-64 only. macOS, Windows, Linux ARM and other platforms are not supported in this release.`, // CLAIM-COVERAGE: README.md
  ...
  "Seal is a gate, not a sandbox. It controls the path through it, and only that path; a direct local write, Bash, network access, subprocesses, other tools, and other servers are outside Seal.", // CLAIM-COVERAGE: README.md
