...
function isolatedTree(t) {
  ...
  for (const relative of ["spine/platform.cjs", "spine/protection.cjs", "spine/uninstall.cjs", "spine/store.cjs", "spine/write.cjs", "spine/version.cjs", "scripts/macos-helper.cjs", "VERSION", "package.json"]) {
