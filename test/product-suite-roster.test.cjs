...
const TEST_GUIDANCE = /Run the complete product suite through the concurrency and CPU guard: \/home\/monkey\/bin\/suiterun -- scripts\/run-complete-product-suite\.sh/;

test("npm test keeps its guarded next step when Node flags are forwarded", () => {
