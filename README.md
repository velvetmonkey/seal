...
> The current source is the unreleased `v0.4.0` candidate. The install commands below fetch the
> published `v0.5.1`, which carries the previous receipt format and Linux-only Protect support.
